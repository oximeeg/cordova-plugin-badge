...
- [enhancement:] Setting launchMode to _singleInstance_ isn't necessary anymore. App does not restart on click anymore.
...
- Added iOS support<br>
  _Based on the Badge iOS plugin made by_ **_Joseph Stuhr_**
